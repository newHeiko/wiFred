...
image::wfred_rev2.png[alt="Schematic sheet 1 for rev0.6]
...
image::wfred-wifi-Wifi_connection.png[alt="Schematic sheet 2 for rev0.6]

[#schematic06page3]
.Schematic sheet for user interface
