...
[#bootJumper06]
.Display of boot jumper
image::wfred-controller_rev2-Controller.png[alt="Schematic sheet 3 for rev0.6]
...
.List of bottom side components - SMDs and pin headers - for the wiFred PCB
|===
...
[#BOM06TOP]
[cols="1,2,1",options="breakable,autowidth"]
.List of top side components - ESP32-S2-WROOM and user interface - for the wiFred PCB
|===
|Designator|Package|Designation
