...
\begin{table}
  ...
  \begin{tabular}{| m{6em} | m{6em} | m{6em} | m{15em} |}
    ...
    \hline
    Off & Flashing & On & Emergency stop, forward direction. Turn speed potentiometer to zero to re-gain control. Also happens when switching direction with speed potentiometer not at zero \\
    \hline
    Off & On & Flashing & Emergency stop, reverse direction. Turn speed potentiometer to zero to re-gain control. Also happens when switching direction with speed potentiometer not at zero \\
    \hline
    \hline
