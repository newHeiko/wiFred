...
enum state { STATE_STARTUP, STATE_CONNECTING, STATE_CONNECTED,
             STATE_LOCO_CONNECTING, STATE_LOCO_ONLINE,
             STATE_CONFIG_AP, STATE_CONFIG_STATION_WAITING, STATE_CONFIG_STATION, STATE_LOWPOWER_WAITING, STATE_LOWPOWER, STATE_POWERDOWN_WAITING, STATE_POWERDOWN };
